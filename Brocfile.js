...
module.exports = function (broccoli) {
  ...
  config = pickFiles(config, {
    ...
    destDir: 'ticker/config'
  });

  tests = pickFiles(tests, {
    srcDir: '/',
    destDir: 'ticker/tests'
  });
  ...
  appAndDependencies = preprocessJs(appAndDependencies, '/', 'ticker');
  ...
  var applicationJs = compileES6(appAndDependencies, {
    ...
    legacyFilesToAppend: [
      'ticker/config/environment.js',
      'ticker/config/environments/' + env + '.js',
      'jquery.js',
      'handlebars.js',
      'ember.js',
      'ic-ajax/main.js',
  ...
  styles = preprocessCss(sourceTrees, 'ticker/styles', '/assets');
